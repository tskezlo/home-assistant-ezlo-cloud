...
3. Confirm **Download** in the version dialog that appears (defaults to the latest release, lands at `/config/custom_components/ezlohacloud`).
4. **Restart Home Assistant** when prompted.
5. Continue to [Configuration](#configuration) below.
